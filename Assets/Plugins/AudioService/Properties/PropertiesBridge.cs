...
namespace Plugins.AudioService.Properties
{
    public class PropertiesBridge
    {
        public PropertiesBridge(Dictionary<int, AudioService.PooledObject> activePool)
        {
            ...
            AudioMixerGroup = new Property<int, AudioMixerGroup>(canAccess, id => activePool[id].Audio.AudioMixerGroup, (id, value) => activePool[id].Audio.AudioMixerGroup = value);
            ...
            BypassListenerEffects = new Property<int, bool>(canAccess, id => activePool[id].Audio.BypassListenerEffects, (id, value) => activePool[id].Audio.BypassListenerEffects = value);
            BypassReverbZones = new Property<int, bool>(canAccess, id => activePool[id].Audio.BypassReverbZones, (id, value) => activePool[id].Audio.BypassReverbZones = value);
            ...
            RolloffMode = new Property<int, AudioRolloffMode>(canAccess, id => activePool[id].Audio.RolloffMode, (id, value) => activePool[id].Audio.RolloffMode = value);
